...
class ModRecipeProvider(generator: DataGenerator) : RecipeProvider(generator) {
    override fun buildCraftingRecipes(pFinishedRecipeConsumer: Consumer<FinishedRecipe>) {
        ...
        ShapelessRecipeBuilder.shapeless(ModItems.EFUM).requires(Items.FLINT).requires(Items.GUNPOWDER).requires(Items.REDSTONE).unlockedBy("has_flint", has(Items.FLINT)).save(pFinishedRecipeConsumer)
        ...
        ShapedRecipeBuilder.shaped(ModItems.RAW_STEEL).define('I', Items.IRON_INGOT).define('C', Items.COAL).pattern(" C ").pattern("CIC").pattern(" C ").unlockedBy("has_iron_ingot", has(Items.IRON_INGOT)).save(pFinishedRecipeConsumer)
        ...
        ShapelessRecipeBuilder.shapeless(Blocks.OXIDIZED_COPPER).requires(ModItems.OXIDIZED_COPPER_INGOT, 9).unlockedBy("has_oxidized_copper_ingot", has(ModItems.OXIDIZED_COPPER_INGOT)).save(pFinishedRecipeConsumer)
        val pigironTrigger = has(ModItems.PIG_IRON_INGOT)
        ShapedRecipeBuilder.shaped(ModItems.PIG_IRON_INGOT).define('T', ModItems.TIN_INGOT).define('C', ModItems.OXIDIZED_COPPER_INGOT).pattern(" T ").pattern("TCT").pattern(" T ").unlockedBy("has_oxidized_copper", has(ModItems.OXIDIZED_COPPER_INGOT)).save(pFinishedRecipeConsumer)
        ShapedRecipeBuilder.shaped(ModItems.PIG_IRON_PICKAXE).define('#', ModItems.PIG_IRON_INGOT).define('S', Items.STICK).pattern("###").pattern(" S ").pattern(" S ").unlockedBy("has_pig_iron_ingot", pigironTrigger).save(pFinishedRecipeConsumer)
        ShapedRecipeBuilder.shaped(ModItems.PIG_IRON_AXE).define('#', ModItems.PIG_IRON_INGOT).define('S', Items.STICK).pattern("## ").pattern("#S ").pattern(" S ").unlockedBy("has_pig_iron_ingot", pigironTrigger).save(pFinishedRecipeConsumer)
        ...
        ShapedRecipeBuilder.shaped(ModItems.PIG_IRON_SHOVEL).define('#', ModItems.PIG_IRON_INGOT).define('S', Items.STICK).pattern(" # ").pattern(" S ").pattern(" S ").unlockedBy("has_pig_iron_ingot", pigironTrigger).save(pFinishedRecipeConsumer)
        ShapedRecipeBuilder.shaped(ModItems.PIG_IRON_HOE).define('#', ModItems.PIG_IRON_INGOT).define('S', Items.STICK).pattern("## ").pattern(" S ").pattern(" S ").unlockedBy("has_pig_iron_ingot", pigironTrigger).save(pFinishedRecipeConsumer)
        ...
        ShapedRecipeBuilder.shaped(ModItems.FIFI_PANTS).define('W', Blocks.PINK_WOOL).define('#', ModItems.FIFI).pattern("WWW").pattern("W W").pattern("# #").unlockedBy("has_fifi", fifiTrigger).save(pFinishedRecipeConsumer)
        ShapedRecipeBuilder.shaped(ModItems.FIFI_SLIPPERS).define('W', Blocks.PINK_WOOL).define('#', ModItems.FIFI).pattern("# #").pattern("W W").unlockedBy("has_fifi", fifiTrigger).save(pFinishedRecipeConsumer)
        ...
        cooking(Ingredient.of(ModItems.SQUID_RINGS), ModItems.COOKED_SQUID_RINGS, 2f, CookingType.SMOKING).save(pFinishedRecipeConsumer)
